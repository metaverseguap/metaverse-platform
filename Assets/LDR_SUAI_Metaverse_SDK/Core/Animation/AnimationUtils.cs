...
namespace LDR.SUAI_Metaverse.SDK.Core.Animations
{
    /// <summary>
    ...
    public static class AnimationUtils
    {
        ...
        public static IEnumerator PlayExternalAnimation(Animator animator, AnimationClip clip)
        {
            yield return PlayExternalAnimation(animator, new List<AnimationClip> { clip });
        }
        ...
        public static IEnumerator PlayExternalAnimation(Animator animator, List<AnimationClip> clipsChain)
        {
            yield return PlayExternalAnimation(animator, PLAYER_EXTERNAL_ANIMATION_CLIP, clipsChain);
        }
