...
{
    /// <summary>
    /// <para>Данный скрипт устанавливает систему merge unity при первом запуске проекта.</para>
    ///
    /// Данный скрипт устанавливает UnityYamlMerge драйвер для git
    /// </summary>
    [InitializeOnLoad]
    public class SetUnityMergeDriver
    {
